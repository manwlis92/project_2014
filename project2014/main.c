...
{  
   ...
   FILE *input_file; FILE *outp1; FILE *outp2; FILE *outp3; FILE *outp4; FILE *outp5;
   ...
   int A = 0; int B = 0;  int inner_enable = 0; int counterA =1;  int counterB=1; int enableA = 1; int enableB = 1; int last =0;
    int i=0;  int ready=0; char A_hex[9]; char B_hex[9]; double hits1B = 0;   double hits2B = 0; double hitsCB = 0;  long int branch=0;
...
fclose(input_file); fclose(outp1); fclose(outp2); fclose(outp3); fclose(outp4); fclose(outp5);
